...
const RatingSubmitMelbourne = ({
  ...
  return (
    <div className="flex flex-col p-6 sm:p-8 bg-white shadow-lg rounded-3xl border border-gray-100 w-full mt-16 min-h-[300px] sm:min-h-[400px]">
...
export default RatingSubmitMelbourne;