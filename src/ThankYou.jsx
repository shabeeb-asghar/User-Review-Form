...
const ThankYou = () => {
  return (
    <div className="flex flex-col items-center justify-center p-6 sm:p-8 bg-white shadow-lg rounded-3xl border border-gray-100 w-full text-center mt-16">
      ...
      <h2 className="text-xl sm:text-2xl w-2/3 font-semibold text-gray-800 mb-2 sm:mb-4">
